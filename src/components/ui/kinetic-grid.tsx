...
export default function KineticGrid({
  ...
  children?: ReactNode;
  className?: string;
  globalColor?: "default" | "monochrome" | "warm";
  transparent?: boolean;
}) {
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        ...
        warm: {
          bg: "#1c1917",
          lineActive: { r: 194, g: 65, b: 12, a: 0.9 },
          nodeActive: { r: 234, g: 88, b: 12, a: 1.0 },
          glow: "234,88,12",
          ripple: "251,191,36",
        },
      }[globalColor ?? "default"];
  ...
  return (
    <div
      className={cn(
        ...
        !transparent && (globalColor === "monochrome" ? "bg-[#000000]" : globalColor === "warm" ? "bg-[#1c1917]" : "bg-[#161618]"),
        className,
      )}
    >
      <canvas
